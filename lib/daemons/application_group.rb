...
module Daemons
  class ApplicationGroup
    ...
    def setup
      @applications = find_applications(pidfile_dir())
      @all_applications = find_all_applications(pidfile_dir())
    end
    ...
    def find_all_applications(dir)
      pid_files = PidFile.find_files(dir, '', ! @keep_pid_files)
      
      #pp pid_files
      
      @monitor = Monitor.find(dir, '' + '_monitor')
